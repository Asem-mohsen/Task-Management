                    ...
                    @php
                        $menuItems = [
                            [
                                ...
                                'active' => function() {
                                    return request()->routeIs('projects.*');
                                },
                                'subItems' => [
                                    [
                                        'title' => 'My Projects',
                                    ...
                                    [
                                        ...
                                        'active' => function() {
                                            return request()->routeIs('projects.create');
                                        }
                                    ]
                                ]
                            ],
                            [
                                ...
                                'subItems' => [
                                    [
                                        ...
                                        'route' => 'tasks.index',
                                        'active' => function() {
                                            return request()->routeIs('tasks.index');
                                        }
                                    ],
                                    [
                                        'title' => 'Create Task',
                                        'route' => 'tasks.create',
                                        'active' => function() {
                                            return request()->routeIs('tasks.create');
                                        }
                                    ]
                                ]
                            ]
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ $item['active']() ? 'here show' : '' }}">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                @foreach ($item['subItems'] as $subItem)
                                    <div class="menu-item">
                                        <a class="menu-link {{ $subItem['active']() ? 'active' : '' }}" href="{{ isset($subItem['type']) ? '#' : route($subItem['route']) }}">
